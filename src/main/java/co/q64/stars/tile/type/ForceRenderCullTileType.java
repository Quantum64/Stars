...
public class ForceRenderCullTileType extends TileEntityType<ForceRenderCullTile> {
    ...
    protected @Inject ForceRenderCullTileType(ForceRenderCullTileFactory factory, DarkAirBlock darkAirBlock, AirDecayBlock airDecayBlock, Identifiers identifiers) {
        super(factory::create, Stream.of(darkAirBlock, airDecayBlock).collect(Collectors.toSet()), null);
